...
class TestSplunkClient(unittest.TestCase):
    ...
    @patch('ansible_collections.community.general.plugins.callback.splunk.time')
    @patch('ansible_collections.community.general.plugins.callback.splunk.open_url')
    def test_top_level_time(self, open_url_mock, mock_time):
        ...
        self.assertEqual(sent_data['time'], 123456.789)
